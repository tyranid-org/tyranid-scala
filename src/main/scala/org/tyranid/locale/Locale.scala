...
object Country extends RamEntity( tid = "a02t" ) {
  ...
  def code3Countries:Seq[Record] = {
    val code3Idx = staticView( 'code3 ).index
    
    staticRecords.filter( _( code3Idx ).as[String] notBlank  ).sortBy( _.s( 'name ) )
  }  
  ...
  s(   "_id", "name",				                                  "code", "code3" )
	...
	s(    4080, "Antigua and Barbuda",                          "AC",   "ATG" )
	s(    4081, "Anguilla",                                     "AV",   "AIA" )
	s(    4082, "Albania",                                      "AL",   "ALB" )
	s(    4083, "Armenia",                                      "AM",   "ARM" )
	s(    4084, "Netherlands Antilles",                         "NT",   "ANT" )
	s(    4085, "Angola",                                       "AO",   "AGO" )
	s(    4088, "Argentina",                                    "AR",   "ARG" )
	s(    4089, "American Samoa",                               "AQ",   "ASM" )
	s(    4090, "Austria",                                      "AU",   "AUT" )
	s(    4091, "Australia",                                    "AS",   "AUS" )
	s(    4092, "Aruba",                                        "AA",   "ABW" )
	s(    4093, "Aland Islands",                                "AX",   "ALE" )
	s(    4094, "Azerbaijan",                                   "AJ",   "AZE" )
	s(    4095, "Bosnia and Herzegovina",                       "BK",   "BIH" )
	s(    4096, "Barbados",                                     "BB",   "BRB" )
	s(    4097, "Bangladesh",                                   "BG",   "BGD" )
	s(    4098, "Belgium",                                      "BE",   "BEL" )
	s(    4099, "Burkina Faso",                                 "UV",   "BDI" )
	s(    4100, "Bulgaria",                                     "BU",   "BGR" )
	s(    4101, "Bahrain",                                      "BA",   "BHR" )
	s(    4102, "Burundi",                                      "BY",   "BDI" )
	s(    4103, "Benin",                                        "BN",   "BEN" )
	s(    4104, "Bermuda",                                      "BD",   "BMU" )
	s(    4105, "Brunei Darussalam",                            "BX",   "BRN" )
	s(    4106, "Bolivia",                                      "BL",   "BOL" )
	s(    4107, "Brazil",                                       "BR",   "BRA" )
	s(    4108, "Bahamas",                                      "BF",   "BHS" )
	s(    4109, "Bhutan",                                       "BT",   "BTN" )
	s(    4110, "Bouvet Island",                                "BV",   "BVT" )
	s(    4111, "Botswana",                                     "BC",   "BWA" )
	s(    4112, "Belarus",                                      "BO",   "BLR" )
	s(    4113, "Belize",                                       "BH",   "BLZ" )
	s(    4114, "Canada",                                       "CA",   "CAN" )
	s(    4115, "Cocos s(Keeling) Islands",                     "CK",   "CCK" )
	s(    4116, "Congo, Democratic Republic of the",            "CG",   "COD" )
	s(    4326, "Congo s(Zaire)",                               "CG",   "COD" )
	s(    4117, "Central African Republic",                     "CT",   "CAF" )
	s(    4118, "Congo",                                        "CF",   "COG" )
	s(    4119, "Switzerland",                                  "SZ",   "CHE" )
	s(    4120, "Cote d'Ivoire",                                "IV",   "CIV" )
	s(    4121, "Cook Islands",                                 "CW",   "COK" )
	s(    4122, "Chile",                                        "CI",   "CHL" )
	s(    4123, "Cameroon",                                     "CM",   "CMR" )
	s(    4124, "China",                                        "CH",   "CHN" )
	s(    4125, "Colombia",                                     "CO",   "COL" )
	s(    4126, "Costa Rica",                                   "CS",   "CRI" )
	s(    4127, "Cuba",                                         "CU",   "CUB" )
	s(    4128, "Cape Verde",                                   "CV",   "CPV" )
	s(    4129, "Christmas Island",                             "KT",   "CXR" )
	s(    4130, "Cyprus",                                       "CY",   "CYP" )
	s(    4131, "Czech Republic",                               "EZ",   "CZE" )
	s(    4132, "Germany",                                      "GM",   "DEU" )
	s(    4133, "Djibouti",                                     "DJ",   "DJI" )
	s(    4134, "Denmark",                                      "DA",   "DNK" )
	s(    4135, "Dominica",                                     "DO",   "DMA" )
	s(    4136, "Dominican Republic",                           "DR",   "DOM" )
	s(    4137, "Algeria",                                      "AG",   "DZA" )
	s(    4138, "Ecuador",                                      "EC",   "ECU" )
	s(    4139, "Estonia",                                      "EN",   "EST" )
	s(    4140, "Egypt",                                        "EG",   "EGY" )
	s(    4141, "Western Sahara",                               "WI",   "ESH" )
	s(    4142, "Eritrea",                                      "ER",   "ERI" )
	s(    4143, "Spain",                                        "SP",   "ESP" )
	s(    4144, "Ethiopia",                                     "ET",   "ETH" )
	s(    4146, "Finland",                                      "FI",   "FIN" )
	s(    4147, "Fiji",                                         "FJ",   "FJI" )
	s(    4148, "Falkland Islands s(Malvinas)",                 "FK",   "FLK" )
	s(    4149, "Micronesia, Federated States of",              "FM",   "FSM" )
	s(    4150, "Faroe Islands",                                "FO",   "FRO" )
	s(    4151, "France",                                       "FR",   "FRA" )
	s(    4152, "Gabon",                                        "GB",   "GAB" )
	s(    4153, "United Kingdom",                               "UK",   "GBR" )
	s(    4154, "Grenada",                                      "GJ",   "GRD" )
	s(    4155, "Georgia",                                      "GG",   "GEO" )
	s(    4156, "French Guiana",                                "FG",   "GUF" )
	s(    4157, "Guernsey",                                     "GK",   "GGY" )
	s(    4158, "Ghana",                                        "GH",   "GHA" )
	s(    4159, "Gibraltar",                                    "GI",   "GIB" )
	s(    4160, "Greenland",                                    "GL",   "GRL" )
	s(    4161, "Gambia",                                       "GA",   "GMB" )
	s(    4162, "Guinea",                                       "GV",   "GIN" )
	s(    4163, "Guadeloupe",                                   "GP",   "GLP" )
	s(    4164, "Equatorial Guinea",                            "EK",   "GNQ" )
	s(    4165, "Greece",                                       "GR",   "GRC" )
	s(    4166, "South Georgia and the South Sandwich Islands", "SX",   "SGS" )
	s(    4167, "Guatemala",                                    "GT",   "GTM" )
	s(    4168, "Guam",                                         "GQ",   "GUM" )
	s(    4169, "Guinea-Bissau",                                "PU",   "GNB" )
	s(    4170, "Guyana",                                       "GY",   "GUY" )
	s(    4172, "Heard Island and McDonald Islands",            "HM",   "HMD" )
	s(    4173, "Honduras",                                     "HO",   "HND" )
	s(    4174, "Croatia",                                      "HR",   "HRV" )
	s(    4175, "Haiti",                                        "HA",   "HTI" )
	s(    4176, "Hungary",                                      "HU",   "HUN" )
	s(    4177, "Indonesia",                                    "ID",   "IDN" )
	s(    4178, "Ireland",                                      "EI",   "IRL" )
	s(    4179, "Israel",                                       "IS",   "ISR" )
	s(    4180, "Isle of Man",                                  "IM",   "IMN" )
	s(    4181, "India",                                        "IN",   "IND" )
	s(    4182, "British Indian Ocean Territory",               "IO",   "IOT" )
	s(    4183, "Iraq",                                         "IZ",   "IRQ" )
	s(    4184, "Iran, Islamic Republic of",                    "IR",   "IRN" )
	s(    4185, "Iceland",                                      "IC",   "ISL" )
	s(    4186, "Italy",                                        "IT",   "ITA" )
	s(    4187, "Jersey",                                       "JE",   "JEY" )
	s(    4188, "Jamaica",                                      "JM",   "JAM" )
	s(    4189, "Jordan",                                       "JO",   "JOR" )
	s(    4190, "Japan",                                        "JA",   "JPN" )
	s(    4191, "Kenya",                                        "KE",   "KEN" )
	s(    4192, "Kyrgyzstan",                                   "KG",   "KGZ" )
	s(    4193, "Cambodia",                                     "CB",   "KHM" )
	s(    4194, "Kiribati",                                     "KR",   "KIR" )
	s(    4195, "Comoros",                                      "CN",   "COM" )
	s(    4196, "Saint Kitts and Nevis",                        "SC",   "KNA" )
	s(    4197, "North Korea",                                  "KN",   "PRK" )
	s(    4198, "South Korea",                                  "KS",   "KOR" )
	s(    4199, "Kuwait",                                       "KU",   "KWT" )
	s(    4200, "Cayman Islands",                               "CJ",   "CYM" )
	s(    4201, "Kazakhstan",                                   "KZ",   "KAZ" )
	s(    4202, "Lao People's Democratic Republic",             "LA",   "LAO" )
	s(    4203, "Lebanon",                                      "LE",   "LBN" )
	s(    4204, "Saint Lucia",                                  "ST",   "LCA" )
	s(    4205, "Liechtenstein",                                "LS",   "LIE" )
	s(    4206, "Sri Lanka",                                    "CE",   "LKA" )
	s(    4207, "Liberia",                                      "LI",   "LBR" )
	s(    4208, "Lesotho",                                      "LT",   "LSO" )
	s(    4209, "Lithuania",                                    "LH",   "LTU" )
	s(    4210, "Luxembourg",                                   "LU",   "LUX" )
	s(    4211, "Latvia",                                       "LG",   "LVA" )
	s(    4212, "Libyan Arab Jamahiriya",                       ""   )
	s(    4213, "Morocco",                                      "MO",   "MAR" )
	s(    4214, "Monaco",                                       "MN",   "MCO" )
	s(    4215, "Moldova, Republic of",                         "MD",   "MDA" )
	s(    4216, "Montenegro",                                   "MW",   "MNE" )
	s(    4217, "Madagascar",                                   "MA",   "MDG" )
	s(    4218, "Marshall Islands",                             "RM",   "MHL" )
	s(    4219, "Macedonia",                                    "MK",   "MKD" )
	s(    4220, "Mali",                                         "ML",   "MLI" )
	s(    4221, "Myanmar",                                      "BM",   "MMR" )
	s(    4222, "Mongolia",                                     "MG",   "MNG" )
	s(    4223, "Macao",                                        "MC",   "MAC" )
	s(    4224, "Northern Mariana Islands",                     "CQ",   "MNP" )
	s(    4225, "Martinique",                                   "MB",   "MTQ" )
	s(    4226, "Mauritania",                                   "MR",   "MRT" )
	s(    4227, "Montserrat",                                   "MH",   "MSR" )
	s(    4228, "Malta",                                        "MT",   "MLT" )
	s(    4229, "Mauritius",                                    "MP",   "MUS" )
	s(    4230, "Maldives",                                     "MV",   "MDV" )
	s(    4231, "Malawi",                                       "MI",   "MWI" )
	s(    4232, "Mexico",                                       "MX",   "MEX" )
	s(    4233, "Malaysia",                                     "MY",   "MYS" )
	s(    4234, "Mozambique",                                   "MZ",   "MOZ" )
	s(    4235, "Namibia",                                      "WA",   "NAM" )
	s(    4236, "New Caledonia",                                "NC",   "NCL" )
	s(    4237, "Niger",                                        "NG",   "NER" )
	s(    4238, "Norfolk Island",                               "NF",   "NFK" )
	s(    4239, "Nigeria",                                      "NI",   "NGA" )
	s(    4240, "Nicaragua",                                    "NU",   "NIC" )
	s(    4241, "Netherlands",                                  "NL",   "NLD" )
	s(    4242, "Norway",                                       "NO",   "NOR" )
	s(    4243, "Nepal",                                        "NP",   "NPL" )
	s(    4244, "Nauru",                                        "NR",   "NRU" )
	s(    4245, "Niue",                                         "NE",   "NIU" )
	s(    4246, "New Zealand",                                  "NZ",   "NZL" )
	s(    4247, "Oman",                                         "MU",   "OMN" )
	s(    4248, "Panama",                                       "PM",   "PAN" )
	s(    4249, "Peru",                                         "PE",   "PER" )
	s(    4250, "French Polynesia",                             "FP",   "PYF" )
	s(    4251, "Papua New Guinea",                             "PP",   "PNG" )
	s(    4252, "Philippines",                                  "RP",   "PHL" )
	s(    4253, "Pakistan",                                     "PK",   "PAK" )
	s(    4254, "Poland",                                       "PL",   "POL" )
	s(    4255, "Saint Pierre and Miquelon",                    "SB",   "SPM" )
	s(    4256, "Pitcairn",                                     "PC",   "PCN" )
	s(    4257, "Puerto Rico",                                  "RQ",   "PRI" )
	s(    4258, "Palestinian Territory",                        "PS",   "PSE" )
	s(    4259, "Portugal",                                     "PO",   "PRT" )
	s(    4260, "Palau",                                        "PS",   "PLW" )
	s(    4261, "Paraguay",                                     "PA",   "PRY" )
	s(    4262, "Qatar",                                        "QA",   "QAT" )
	s(    4263, "Reunion",                                      "RE",   "REU" )
	s(    4264, "Romania",                                      "RO",   "ROU" )
	s(    4265, "Serbia",                                       "RI",   "SRB" )
	s(    4266, "Russian Federation",                           "RS",   "RUS" )
	s(    4267, "Rwanda",                                       "RW",   "RWA" )
	s(    4268, "Saudi Arabia",                                 "SA",   "SAU" )
	s(    4269, "Solomon Islands",                              "BP",   "SLB" )
	s(    4270, "Seychelles",                                   "SE",   "SYC" )
	s(    4271, "Sudan",                                        "SU",   "SDN" )
	s(    4272, "Sweden",                                       "SW",   "SWE" )
	s(    4273, "Singapore",                                    "SN",   "SGP" )
	s(    4274, "Saint Helena",                                 "SH",   "SHN" )
	s(    4275, "Slovenia",                                     "SI",   "SVN" )
	s(    4276, "Svalbard and Jan Mayen",                       "SV",   "SJM" )
	s(    4277, "Slovakia",                                     "LO",   "SVK" )
	s(    4278, "Sierra Leone",                                 "SL",   "SLE" )
	s(    4279, "San Marino",                                   "SM",   "SMR" )
	s(    4280, "Senegal",                                      "SG",   "SEN" )
	s(    4281, "Somalia",                                      "SO",   "SOM" )
	s(    4282, "Suriname",                                     "NS",   "SUR" )
	s(    4283, "Sao Tome and Principe",                        "TP",   "STP" )
	s(    4284, "El Salvador",                                  "ES",   "SLV" )
	s(    4285, "Syria",                                        "SY",   "SYR" )
	s(    4286, "Swaziland",                                    "WZ",   "SWZ" )
	s(    4287, "Turks and Caicos Islands",                     "TK",   "TCA" )
	s(    4288, "Chad",                                         "CD",   "TCD" )
	s(    4289, "French Southern Territories",                  "FS",   "ATF" )
	s(    4290, "Togo",                                         "TO",   "TGO" )
	s(    4291, "Thailand",                                     "TH",   "THA" )
	s(    4292, "Tajikistan",                                   "TI",   "TJK" )
	s(    4293, "Tokelau",                                      "TL",   "TLK" )
	s(    4294, "Timor-Leste",                                  "TT",   "TLS" )
	s(    4295, "Turkmenistan",                                 "TX",   "TKM" )
	s(    4296, "Tunisia",                                      "TS",   "RUN" )
	s(    4297, "Tonga",                                        "TN",   "TON" )
	s(    4298, "Turkey",                                       "TU",   "TUR" )
	s(    4299, "Trinidad and Tobago",                          "TD",   "TTO" )
	s(    4300, "Tuvalu",                                       "TV",   "TUV" )
	s(    4301, "Taiwan",                                       "TW",   "TWN" )
	s(    4302, "Tanzania, United Republic of",                 "TZ",   "TZA" )
	s(    4303, "Ukraine",                                      "UP",   "UKR" )
	s(    4304, "Uganda",                                       "UG",   "UGA" )
	s(    4305, "United States Minor Outlying Islands",         "UM",   "UMI" )
	s(    4306, "United States",                                "US",   "USA" )
	s(    4307, "Uruguay",                                      "UY",   "URY" )
	s(    4308, "Uzbekistan",                                   "UZ",   "UZB" )
	s(    4309, "Holy See s(Vatican City State)",               "VT",   "VAT" )
	s(    4310, "Saint Vincent and the Grenadines",             "VC",   "VCT" )
	s(    4311, "Venezuela",                                    "VE",   "VEN" )
	s(    4312, "Virgin Islands, British",                      "VI",   "VGB" )
	s(    4313, "Virgin Islands, U.S.",                         "VQ",   "VIR" )
	s(    4314, "Vietnam",                                      "VM",   "VNM" )
	s(    4315, "Vanuatu",                                      "NH",   "VUT" )
	s(    4316, "Wallis and Futuna",                            "WF",   "WLF" )
	s(    4317, "Samoa",                                        "WS",   "WSM" )
	s(    4318, "Yemen",                                        "YM",   "YEM" )
	s(    4319, "Mayotte",                                      "MF",   "MYT" )
	s(    4320, "South Africa",                                 "SF",   "ZAF" )
	s(    4321, "Zambia",                                       "ZA",   "ZMB" )
	s(    4322, "Zimbabwe",                                     "ZI",   "ZWE" )
	s(    4323, "Metropolitan France",                          ""   )
	s(    4325, "Yugoslavia",                                   "YU" )
  s(    4327, "Antartica",                                    "AQ",   "ATA" )
  s(    4328, "Hong Kong",                                    "HK",   "HKG" )
  s(    4329, "Libya",                                        "LY",   "LBY" )
  s(    4330, "Saint Barthelemy",                             "TB",   "BLM" )
  s(    4331, "Saint Martin",                                 "RN",   "MAF" )
  }
}
